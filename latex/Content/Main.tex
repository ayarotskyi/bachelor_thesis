...
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.9\linewidth]{pipeline_diagram.pdf} % Replace with actual file
%   \caption{Schematic representation of the control inference pipeline including client and server modules.}
%   \label{fig:pipeline}
% \end{figure}
